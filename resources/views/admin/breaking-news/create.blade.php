...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <form action="{{ route('admin.breaking-news.store') }}" method="POST" class="bg-white p-6 rounded-[6px] border border-[#E8E8E8] shadow-xs space-y-5">
        @csrf
        ...
        <div>
            ...
            <input 
                ...
                id="headline" 
                value="{{ old('headline') }}" 
                placeholder="Contoh: Gempa Magnitudo 6,2 Guncang Pesisir Barat Sumatra"
        ...
        <div class="space-y-4 pt-2 border-t border-[#E8E8E8]">
            <p class="text-xs font-bold text-[#111111] uppercase tracking-wider">Tautan Tujuan (Pilih salah satu atau kosongkan untuk warta teks saja)</p>
            ...
            <div>
                ...
                <input 
                    ...
                    placeholder="https://example.com/siaran-pers"
        ...
        <div class="pt-2">
            <label class="flex items-center gap-2 text-xs font-bold text-[#111111] cursor-pointer">
                ...
                />
                <span>Aktifkan langsung breaking news ini sekarang</span>
            </label>
        </div>
